 ...
 * {@link second_fragment.OnSecondFragmentInteractionListener} interface
...
public class second_fragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnSecondFragmentInteractionListener(uri);
        }
    }
    ...
    public interface OnSecondFragmentInteractionListener {
        ...
        void OnSecondFragmentInteractionListener(Uri uri);
    }
}
